...
which is an amazing schema validation library which generates TypeScript types from your schema.
...
The parameter and return values of these functions are automatically generated based on the Zod schema,
